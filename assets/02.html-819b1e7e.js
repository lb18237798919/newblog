import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as l,c,e as t,a,b as s,d as p}from"./app-1c846d8b.js";const r={},u={href:"https://stylelint.io/",target:"_blank",rel:"noopener noreferrer"},d={href:"https://stylelint.io/user-guide/rules/list",target:"_blank",rel:"noopener noreferrer"};function v(k,n){const e=o("ExternalLinkIcon");return l(),c("div",null,[n[5]||(n[5]=t('<h1 id="_02-【css-代码规范】" tabindex="-1"><a class="header-anchor" href="#_02-【css-代码规范】" aria-hidden="true">#</a> 02 【CSS 代码规范】</h1><h2 id="_1-stylelint介绍及安装" tabindex="-1"><a class="header-anchor" href="#_1-stylelint介绍及安装" aria-hidden="true">#</a> 1. Stylelint介绍及安装</h2><h3 id="_1-1-什么是stylelint" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是stylelint" aria-hidden="true">#</a> 1.1 什么是Stylelint</h3><p>Stylelint是一个强大的，现代的代码检查工具，与ESLint类似，Stylelint能够通过定义一系列的编码风格规则帮助我们避免在样式表中出现错误。</p><p>目前在开源社区上，关于CSS Lint的解决方案主要包括了csslint、SCSS-Lint和Stylelint等几种。而由于Stylelint在技术架构上基于AST 的方式扩展CSS，除原生CSS 语法，其也支持 SCSS、Less 这类预处理器，并且也有非常多的第三方插件，因此我们团队选择了Stylelint作为CSS Lint工具。</p>',5)),a("p",null,[n[1]||(n[1]=s("官方文档：")),a("a",u,[n[0]||(n[0]=s("https://stylelint.io/")),p(e)])]),n[6]||(n[6]=t(`<h3 id="_1-2-安装stylelint" tabindex="-1"><a class="header-anchor" href="#_1-2-安装stylelint" aria-hidden="true">#</a> 1.2 安装Stylelint</h3><p>可以选采用npm安装Stylelint。其中，stylelint-config-standard是Stylelint的标准配置。如果想使用airbnb或prettier的规范，也可以将stylelint-config-standard改为stylelint-config-airbnb或stylelint-config-prettier。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install stylelint stylelint-config-standard --save-dev
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>（3）rules</strong></p>`,29)),a("p",null,[n[3]||(n[3]=s("rules定义了一个对象，属性名为规则名称，属性值为规则取值，它告诉Stylelint该检查什么，该怎么报错，所有的")),a("a",d,[n[2]||(n[2]=s("规则")),p(e)]),n[4]||(n[4]=s("都是默认关闭的。我们可以通过该选项开启相应规则，进行相应的检测。所有规则必须显式的进行配置，因为没有默认值。"))]),n[7]||(n[7]=t(`<p>规则名称主要由两个部分组成，第一部分描述该规则应用于什么东西，第二部分表示该规则检查了什么。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token string">&quot;number-leading-zero&quot;</span>
