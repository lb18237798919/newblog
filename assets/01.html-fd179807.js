import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as c,c as o,e as p,a as n,b as a,d as t}from"./app-1c846d8b.js";const u={},r={href:"https://less.bootcss.com/",target:"_blank",rel:"noopener noreferrer"},d={href:"http://nodejs.cn/download/",target:"_blank",rel:"noopener noreferrer"};function v(k,s){const e=i("ExternalLinkIcon");return c(),o("div",null,[s[7]||(s[7]=p('<h1 id="less基础" tabindex="-1"><a class="header-anchor" href="#less基础" aria-hidden="true">#</a> Less基础</h1><h2 id="_1-维护css的弊端" tabindex="-1"><a class="header-anchor" href="#_1-维护css的弊端" aria-hidden="true">#</a> 1.维护CSS的弊端</h2><p>CSS 是一门非程序式语言，没有变量、函数、SCOPE（作用域）等概念。</p><ul><li>CSS 需要书写大量看似没有逻辑的代码，CSS 冗余度是比较高的</li><li>不方便维护及扩展，不利于复用</li><li>CSS 没有很好的计算能力</li><li>非前端开发工程师来讲，往往会因为缺少 CSS 编写经验而很难写出组织良好且易于维护的 CSS 代码项目</li></ul><h2 id="_2-less介绍" tabindex="-1"><a class="header-anchor" href="#_2-less介绍" aria-hidden="true">#</a> 2.Less介绍</h2><p>Less（Leaner Style Sheets 的缩写）是一门 CSS 扩展语言，也称为 CSS 预处理器。</p><p>做为 CSS 的一种形式的扩展，它并没有减少 CSS 的功能，而是在现有的 CSS 语法上，为 CSS 加入程序式语言的特性。</p><p>它在 CSS 的语法基础上，引入了变量，Mixin（混入），运算以及函数等功能，大大简化了 CSS 的编写，并且降低了 CSS 的维护成本，就像它的名称所说的那样，Less 可以让我们用更少的代码做更多的事情。</p>',8)),n("p",null,[s[1]||(s[1]=a("Less 中文网址：")),n("a",r,[s[0]||(s[0]=a("Less 快速入门 | Less.js 中文文档 - Less 中文网 (bootcss.com)")),t(e)])]),s[8]||(s[8]=n("p",null,"常见的 CSS 预处理器：Sass、Less、Stylus",-1)),s[9]||(s[9]=n("p",null,"一句话：Less 是一门 CSS 预处理语言，它扩展了 CSS 的动态特性。",-1)),s[10]||(s[10]=n("h2",{id:"_3-less安装-注意如果使用vscode无需安装less",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_3-less安装-注意如果使用vscode无需安装less","aria-hidden":"true"},"#"),a(" 3.Less安装（注意如果使用VSCode无需安装Less）")],-1)),s[11]||(s[11]=n("p",null,[n("strong",null,"用node运行Less")],-1)),n("ol",null,[n("li",null,[s[3]||(s[3]=a("安装 node.js，可选择版本（8.0），网址：")),n("a",d,[s[2]||(s[2]=a("http://nodejs.cn/download/")),t(e)])]),s[4]||(s[4]=n("li",null,[a("检查是否安装成功，使用 cmd 命令输入 "),n("code",null,"node -v"),a(" 查看版本即可")],-1)),s[5]||(s[5]=n("li",null,[a("基于 node.js 在线安装 Less，使用 cmd 命令输入 "),n("code",null,"npm install -g less"),a(" 即可")],-1)),s[6]||(s[6]=n("li",null,[a("检查是否安装成功，使用 cmd 命令 "),n("code",null,"lessc -v"),a(" 查看版本即可")],-1))]),s[12]||(s[12]=p(`<p><strong>vscode使用Less</strong></p><p>本质上，Less 包含一套自定义的语法及一个解析器，用户根据这些语法定义自己的样式规则，这些规则最终会通过解析器，编译生成对应的 CSS 文件。</p><p>所以，我们需要把我们的 Less 文件，编译生成为 CSS 文件，这样我们的 HTML 页面才能使用。</p><p>【VSCode Less 插件】</p><p>vscode 的 Easy LESS 插件</p><p>这个插件可以自动将<code>less</code>文件转义成<code>css</code>文件 <strong>关于配置</strong></p><figure><img src="https://i0.hdslb.com/bfs/album/414fbd1d48b8bce8313ae5ddc66469d7b3548974.png" alt="image-20220820200608896" tabindex="0" loading="lazy"><figcaption>image-20220820200608896</figcaption></figure><p><strong>settings.json配置如下</strong></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token property">&quot;less.compile&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,113))])}const g=l(u,[["render",v],["__file","01.html.vue"]]);export{g as default};
