import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as e,e as p}from"./app-ec23f145.js";const t={};function o(i,n){return a(),e("div",null,n[0]||(n[0]=[p(`<h1 id="_03-【流程控制语句】" tabindex="-1"><a class="header-anchor" href="#_03-【流程控制语句】" aria-hidden="true">#</a> 03 【流程控制语句】</h1><h2 id="_1-基本介绍" tabindex="-1"><a class="header-anchor" href="#_1-基本介绍" aria-hidden="true">#</a> 1.基本介绍</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code> <span class="token operator">*</span>
...
1
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-初识算法" tabindex="-1"><a class="header-anchor" href="#_8-初识算法" aria-hidden="true">#</a> 8.初识算法</h2><p>算法：解决方案的准确而完整的描述！</p><ul><li>输入</li><li>输出</li><li>有穷性</li><li>确定性</li><li>可行性</li></ul><blockquote><p>好的算法还要满足：可读性、健壮性！</p></blockquote>`,54)]))}const r=s(t,[["render",o],["__file","03.html.vue"]]);export{r as default};
